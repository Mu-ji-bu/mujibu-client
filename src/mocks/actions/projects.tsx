...
export function generateData(total: number = 10) {
  const projects = [];
  ...
  for (let i = 0; i < total; i++) {
    ...
    const project = {
      ...
      projectProposer: { id: String(i), name: 'John Doe' },
      projectImage: `/${i < 3 ? 'slides' : 'shop'}/Desktop_${i < 3 ? 'slides' : 'shop'}_${(i % 3) + 1}@2x.png`,
      projectName: 'Balance衡壓坐墊｜市場唯一衡壓概念健康坐墊，坐出 Q 軟好體態！',
      startTime: '2023-05-01T00:00:00Z',
      endTime: '2023-06-30T23:59:59Z',
      projectType: projectFormEnum.LONG_TERM, // "long-term"
