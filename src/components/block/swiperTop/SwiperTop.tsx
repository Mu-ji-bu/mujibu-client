  ...
  return (
    <div className="swiper-box relative w-screen flex justify-center">
      ...
      <div
        className={clsxm(
          'btn-left',
          'absolute top-1/2 left-[2%] xl:left-[14%] z-50',
          'bg-green-accent bg-opacity-80',
          'w-[60px] h-[60px] rounded-full',
        )}
      >
        <IconButton
          className="custom-swiper-button-prev w-full h-full text-secondary"
          aria-label="backward"
          onClick={goPrev}
        >
      ...
      <div
        className={clsxm(
          'btn-right',
          'absolute top-1/2 right-[2%] xl:right-[14%] z-50',
          'bg-green-accent bg-opacity-80',
          'w-[60px] h-[60px] rounded-full',
        )}
      >
        <IconButton
          className="custom-swiper-button-next w-full h-full text-secondary"
          aria-label="backward"
          onClick={goNext}
        >
