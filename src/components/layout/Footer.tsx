...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center" style={{ padding: '60px 0px' }}>
      <div className="infos flex">
        <div className="image mr-[134px]">
          <Link href={'/'}>
            <Image src={'/logo@2x.png'} alt={'mujibu logo'} width={128} height={48} />
          </Link>
        </div>
        <div className="about w-44">
          <Typography component="p" variant="caption" className="mb-3">
            關於
          </Typography>
          <div className="links flex flex-col">
            <Link
              className="text-[14px] text-secondary-66 no-underline visited:text-secondary-66 mb-3"
              href={'/aboutus'}
            >
              關於我們
            </Link>
            <Link className="text-[14px] text-secondary-66 no-underline visited:text-secondary-66" href={'/faq'}>
              聯繫我們
            </Link>
          </div>
        </div>
        <div className="support w-44">
          <Typography component="p" variant="caption" className="mb-3">
            支援
          </Typography>
          <div className="links flex flex-col">
        ...
        <div className="follow w-44 ml-[390px]">
          <Typography component="p" variant="caption" className="mb-3">
            追蹤我們
          </Typography>
          <Button variant="outlined" color="secondary" className="p-[6px] min-w-0 mr-5" aria-label="facebook">
            <Facebook />
          </Button>
          <Button variant="outlined" color="secondary" className="p-[6px] min-w-0 mr-5" aria-label="line">
      ...
      <div className="copyright mt-10 mb-15">
        <Typography component="p" variant="caption" className="text-secondary-30">
          Copyright © 募質部 Mujibu 2023 All right reserved.
        </Typography>
      </div>
    </footer>
  );
