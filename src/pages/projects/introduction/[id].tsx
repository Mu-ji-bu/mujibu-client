  ...
  return (
    <>
      {isLoading ? (
        ...
        <ProjectsLayout projectState={project}>
          <div className="details w-full flex justify-center gap-6">
            <div className="flex flex-col w-2/3 my-auto">
              {(project?.latestNews as string[]).map((news, i) => (
                <div key={i} className="news mb-8 h-16 flex items-center bg-gray-light pl-5 rounded-lg">
              ...
              <div className="desc p-5 mb-8 bg-green-accent-10 rounded-lg border border-solid border-green-accent">
                <Typography component="p" variant="body20" className="text-primary">
                  {project.projectDescription}
                </Typography>
              </div>
              <Image
                src={carouselDataList[0].projectImage || '/project/Desktop_Project_1.png'}
                alt="project1"
                width={0}
                height={0}
                sizes="100vw"
