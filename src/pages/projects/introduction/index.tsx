          ...
          <ProjectsLayout projectState={carouselDataList[0]} tabIndex={2}>
            <div className="details w-full flex justify-center gap-6">
              ...
              <div className="w-1/3 flex flex-col gap-6">
                <ProjectPlan
                  projectId={carouselDataList[0]._id || '0'}
                  // projectPlan={carouselDataList[0].projectPlans[0] ?? fakeProjectPlan}
                  projectPlan={fakeProjectPlan}
                  handleProjectPlanClick={handleProjectPlanClick}
                />
                <ProjectPlan
                  projectId={carouselDataList[1]._id || '1'}
                  projectPlan={fakeProjectPlan}
                  handleProjectPlanClick={handleProjectPlanClick}
                />
                <ProjectPlan
                  projectId={carouselDataList[2]._id || '2'}
                  projectPlan={fakeProjectPlan}
                  handleProjectPlanClick={handleProjectPlanClick}
                />
              </div>
